...
numberOfRoundsForm.addEventListener("change", () => {
    formChoice.style.display = "block";
});
formChoice.addEventListener(
    "change",
    (getInput = () => {
        const numberOfRounds = parseInt(
            document.querySelector('input[name="numberOfRounds"]:checked').value
        );
...
function displayWinner() {
    userScore > computerScore
        ? ((counterRounds.innerHTML =
              "You win the game!" + '<i class="fa-regular fa-face-smile"></i>'),
          (counterRounds.style.fontSize = "1.5rem"),
          (numRounds.innerHTML = ""))
        : userScore < computerScore
        ? ((counterRounds.innerHTML =
          ...
          (counterRounds.style.fontSize = "1.5rem"),
          (numRounds.innerHTML = ""))
        : ((counterRounds.innerHTML = "The game is a draw!"),
          (counterRounds.style.fontSize = "1.5rem"),
          (numRounds.innerHTML = ""));
